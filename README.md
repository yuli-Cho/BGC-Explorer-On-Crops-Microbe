...
Please run `git_example.R` to generate the following result graph  
...
## Use PANX-BGC  
`git_example.R` First, DEseq2 is used to perform conventional differential analysis and principal component analysis (PCA).  
